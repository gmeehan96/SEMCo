    ...
    search_space_final = {
        "clothing": {
            "sparsemax": {
                ...
                "distil_scale": 6,
                "student_sm_scale": 16,
                "student_training_epochs": 25,
                "student_warmup_epochs": 1,
                "sub_batch_neighbors": 10,
                "teacher_sm_scale": 14,
            },
            "entmax15": {
                "cl_weight": 1,
                ...
                "distil_scale": 3,
                "student_sm_scale": 4,
                "student_training_epochs": 15,
                "student_warmup_epochs": 5,
                "sub_batch_neighbors": 5,
                "teacher_sm_scale": 2.5,
            },
        },
        "microlens": {
            "sparsemax": {
        ...
        "onion": {
            ...
            "entmax15": {
                ...
                "ema_momentum": 0.5,
                "distil_scale": 2,
                "student_sm_scale": 4.5,
                "student_training_epochs": 20,
                "student_warmup_epochs": 1,
                "sub_batch_neighbors": 15,
                "teacher_sm_scale": 2,
            },
        },
        "electronics": {
